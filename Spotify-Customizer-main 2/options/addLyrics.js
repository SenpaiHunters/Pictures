...
function logError(error) {
  ...
  // You can perform additional logging actions here, such as sending error reports to a server
}

// Function to log events
function logEvent(eventName, eventData) {
  console.log("Event:", eventName, eventData);
  // You can perform additional logging actions here, such as tracking event statistics
}

// Function to log performance metrics
function logPerformance(metricName, value) {
  console.log("Performance:", metricName, value);
  // You can perform additional logging actions here, such as analyzing performance data
}

// Function to log network requests
function logNetworkRequest(request) {
  console.log("Network Request:", request);
  // You can perform additional logging actions here, such as analyzing network requests
}
  ...
  if (exe == true) {
    let css = `
      ...
      :root {
        ...
        --hover-color-nav-bar: var(--progress-bar--background-color) !important;
        /**/
        --bg-img: url("https://user-images.githubusercontent.com/103985728/245748577-6b8f3bde-7a4d-48b4-874f-2eda2afae965.jpg") !important;
        ...
        /*- Streaming to device background -*/
        --str-bg: url("https://user-images.githubusercontent.com/103985728/244695862-fc390f5d-a98b-40be-9323-a8e2e839afce.jpeg");
        /* ↑ background of the device streaming to popout */
        --str-color: rgba(0, 0, 0, 0.479);
        /* ↑ background/or color of the device streaming to popout */
      ...
      .JG5J9NWJkaUO9fiKECMA {
        ...
        box-shadow: 16px 5px 10px -7px rgba(0, 0, 0, 1),
          -7px 5px 10px -7px rgba(0, 0, 0, 1), 3px 3px 4px #000, 0px 0px 2px #000;
      ...
      .RowButton-sc-xxkq4e-0.hIehTT:hover {
        background: var(--hovercolor) !important;
        /*- var(--hover-color-nav-bar) -*/
      }
      /* fix margin */
      .lyVkg68L7ycnwyOcO3vj {
      ...
      /* wont even fucking matter with that new shit added??? */
      ...
      [aria-label="Keyboard\ Shortcuts"]
        > :first-child:has([aria-label="Close"] svg) {
        background: var(--hot-color) !important;
        background-image: var(--hot-bg) !important;
        background-size: cover !important;
        background-attachment: fixed !important;
        background-repeat: no-repeat !important;
        background-blend-mode: soft-light !important;
      ...
      .VqUjiYOlfxlk_lFOusZ7 {
        ...
        /*backdrop-filter: blur(70px) !important;
                background-color: transparent !important;
                background: transparent !important;  
                background: -webkit-gradient(linear,left bottom,left top,from(var(--generic-tooltip-background-color)),to(transparent)) !important;
                background: linear-gradient(to top,var(--generic-tooltip-background-color) 0,transparent 100%) !important;
                background: rgba(239, 224, 224, 0.158) !important;
      ...
      @supports (backdrop-filter: blur(20px)) or (-webkit-backdrop-filter: blur(20px)) {
        ...
        */
        ...
        .RfdRTSGwulyQdDepLUTT .EeWTFG_vxLI5QJc1TH4F,
        .RfdRTSGwulyQdDepLUTT .eAXFT6yvz37fvS1lmt6k {
          display: none;
        }
    ...
    if (document.getElementById("skin") == null) {
      console.log("CSS Functions Finished");
      const endTime = new Date().getTime();
      const elapsedTime = endTime - startTime;
      console.log("Elapsed Time:", elapsedTime, "ms");
      logPerformance("CSS Functions", elapsedTime);
    }
    // record elapsed time
