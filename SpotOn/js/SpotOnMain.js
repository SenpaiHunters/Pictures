...
function skin(exe, anim, das, tlyr) {
  if (exe == true) {
   ...
   .Xz3tlahv16UpqKBW5HdK {
     ...
     /* Liked songs background image */
     [data-testid="playlist-page"] .contentSpacing [data-testid="playlist-image"] [aria-hidden="false"] {
         display: none !important;
     }
        [data-testid="playlist-page"] .contentSpacing [data-testid="playlist-image"] > [draggable="false"] {
         background-image: var(--album-art) !important;
...
setInterval(function () {
  if (document.getElementsByClassName('xaKMcFuZK3bEXbt3bPdg')[1] != undefined) {
    for (i = 0; i < document.getElementsByClassName('xaKMcFuZK3bEXbt3bPdg').length; i++) {
      document.getElementsByClassName('xaKMcFuZK3bEXbt3bPdg')[i].style.backgroundColor =
        document.getElementsByClassName('xaKMcFuZK3bEXbt3bPdg')[i].style.backgroundColor.slice(0, -1) + ', 0.3)';
    }
  }
  if (document.getElementsByClassName('IyZpbhJE52K9fkJmGbAj')[1] != undefined) {
    for (i = 0; i < document.getElementsByClassName('IyZpbhJE52K9fkJmGbAj').length; i++) {
      document.getElementsByClassName('IyZpbhJE52K9fkJmGbAj')[i].style.backgroundColor =
        document.getElementsByClassName('IyZpbhJE52K9fkJmGbAj')[i].style.backgroundColor.slice(0, -1) + ', 0.3)';
    }
  }
  ...
  if (document.getElementsByClassName('os-viewport os-viewport-native-scrollbars-invisible')[1] != undefined) {
    document.getElementsByClassName('os-viewport os-viewport-native-scrollbars-invisible')[1].onscroll = function () {
      document.getElementsByClassName('under-main-view')[0].style.opacity =
        1 - document.getElementsByClassName('os-viewport os-viewport-native-scrollbars-invisible')[1].scrollTop / 1000 * 5;
      document.querySelector('div.under-main-view').style.transform =
        'translateY(-' + (document.getElementsByClassName('os-viewport os-viewport-native-scrollbars-invisible')[1].scrollTop + 60) + 'px)';
      scrolltimeout = 1;
    };
  }
