window.onload = async function () {
  ...
  function updateOptions() {
    chrome.tabs.query(queryOptions, tabs => {
      ...
      root.style.setProperty('--now-playing-color', options.nowPlayingColor);
      root.style.setProperty('--nav-bar-color', options.navBarColor);
      root.style.setProperty('--song-color', options.songColor);
    });
  }
