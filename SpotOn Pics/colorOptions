...
function updateColorConversionResult() {
...
function updateGradientGenerationResult() {
...
hexColorInput.addEventListener("input", updateColorConversionResult);

// Event listener for conversion type change
conversionTypeSelect.addEventListener("change", updateColorConversionResult);

// Event listener for gradient direction change
gradientDirectionSelect.addEventListener(
  "change",
  updateGradientGenerationResult
);

// Event listener for gradient colors input change
gradientColorsInput.addEventListener("input", updateGradientGenerationResult);
...
clearColorsButton.addEventListener("click", () => {
  gradientColorsInput.value = "";
  updateGradientGenerationResult(); // Clear the gradient display
});
...
alphaSlider.addEventListener("input", () => {
  ...
  updateColorConversionResult(); // Update color conversion with the new alpha value
});
